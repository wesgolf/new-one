...
export class SpotifyScraper extends IPlatformScraper {
  name: 'spotify' = 'spotify';

  async checkLoginState(page: Page): Promise<boolean> {
    await page.goto('https://artists.spotify.com/c/artist/home');
    const url = page.url();
  ...
  async scrape(page: Page): Promise<any> {
    ...
    return {
      profile: { name: 'Spotify Artist', url: '', followers: 0, following: 0, trackCount: 0, totalPlays: 0 },
      tracks: [],
